...
static void USBSuspend(void)
{
    ...
    #if defined(__18CXX)
        U1CON |= 0x02;                   // Put USB module in power conserve
...
static void USBWakeFromSuspend(void)
{
    ...
    USB_WAKEUP_FROM_SUSPEND_HANDLER(EVENT_RESUME,0,0);
        ...
        U1CON  &= (0xFF - 0x02);   // Bring USB module out of power conserve
                                   // mode.
    #endif
